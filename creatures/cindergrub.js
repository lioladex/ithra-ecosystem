...
creaturesData.push({
        ...
        notes: [
            ...
            ["", "<strong>ระบบเตือนภัยธรรมชาติ</strong>: มันไวต่อแรงสั่นสะเทือนใต้พิภพเป็นพิเศษ เมื่อฝูง Cindergrub มุดหนีพร้อมกันเป็นจำนวนมาก บางครั้งนั่นคือสัญญาณเตือนล่วงหน้าของการปะทุภูเขาไฟที่นักสำรวจบนเกาะเรียนรู้ที่จะสังเกต"],
