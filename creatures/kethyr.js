/* ITH-217-905 — Kethyr — ทดสอบ ALIEN INTENSITY SCALE Tier V */
creaturesData.push({
        id: "ITH-217-905", name: "Kethyr", nickname: "สิ่งใต้น้ำแข็ง", status: "ALIVE", era: "ยุคป่าหมอก (Mistwood Era)",
        ...
        desc: "สิ่งมีชีวิตที่ไม่มีใครเคยเห็นตัวเต็มจริงๆ ส่วนที่โผล่พ้นน้ำแข็งให้เห็นในแต่ละถ้ำน้ำแข็งดูเหมือนเป็นคนละส่วนของร่างเดียวกันที่ฝังลึกอยู่ในธารน้ำแข็งทั้งผืน เชื่อกันว่ารอดพ้นภัยพิบัติมาได้หลายยุคสมัย อาจเก่าแก่กว่าแม้แต่ยุคหมุนเวียนที่สัญชาตญาณที่ไม่เคยเห็นตัวยังมีชีวิตอยู่ พ่นไอเย็นจัดที่แช่แข็งเป้าหมายได้แทบจะทันที",
