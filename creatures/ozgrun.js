...
creaturesData.push({
        ...
        desc: "สัตว์ขุดรากภาคพื้นที่หุ้มตัวด้วยแผ่นเกราะแร่ธาตุที่มันดูดซึมจากดินโคลนแล้วตกผลึกขึ้นเองบนผิวหนัง เมื่อถูกคุกคามจะม้วนตัวกลมสนิทจนแทบไม่มีจุดอ่อนให้กัด พร้อมยื่นปุ่มเรืองแสงลวงเป้าที่ปลายหางออกด้านนอกวงแทนตำแหน่งจุดอ่อนจริง ผู้ล่าเดี่ยวที่ไม่รู้ทันมักกัดผิดจุดไปโดนเกราะหนาเปล่าๆ ฝูงเจ้าตัวสี่ขาตัวเดียวจึงแทบไม่มีทางเจาะเกราะได้เลย ต้องอาศัยตัวหนึ่งพลิกตัวมันหงายในขณะที่อีกตัวเจาะจุดอ่อนกลางวงที่แท้จริงพร้อมกัน จึงกลายเป็นเหยื่อที่สอนบทเรียนเรื่อง <em>การล่าเป็นทีมและการรู้ทันกลลวง</em> ให้ฝูงได้ชัดที่สุด",
        ...
        social: "อยู่ตัวเดียวหรือคู่แม่ลูก ขุดโพรงตื้นตามรากไม้ใหญ่ ไม่รวมฝูงเพราะไม่มีเหตุผลต้องป้องกันตัวเป็นกลุ่ม — เกราะของแต่ละตัวเพียงพออยู่แล้วต่อนักล่าเดี่ยวทุกชนิดในป่า ยกเว้นฝูงเจ้าตัวสี่ขาที่ล่าเป็นทีม",
        head: [
            ...
            ["EXTRA #1", "แผ่นเกราะแร่ธาตุตกผลึก (Crystalline Bio-plating)", "ผิวหนังดูดซึมแร่ธาตุจากดินโคลนแล้วตกผลึกเป็นแผ่นแข็งซ้อนกันเป็นชั้นๆ ทั่วหลังและข้างลำตัว แข็งพอจะกันเขี้ยวเจ้าตัวสี่ขาตัวเดียวกัดไม่เข้าเลย"],
        ...
        limbs: [
            ...
            ["#2", "ขา", "ขาหลัง", "สั้นป้อมเช่นกัน ใช้ดันตัวม้วนกลมหรือดันตัวคืบคลานช้าๆ เท่านั้น ความเร็วสูงสุดแทบเท่าการเดินของร่างสี่ขา"]
        ],
        skin: [
        ...
        mutationFull: {
            ...
            conDesc: "กล้ามเนื้อที่ใช้ม้วนตัวไม่มีแรงมากพอจะพลิกกลับคืนท่ายืนได้เองหากถูกพลิกหงาย และปุ่มลวงเป้าก็หลอกได้แค่ผู้ล่าที่ไม่เคยรู้ทันมาก่อนเท่านั้น — ฝูงเจ้าตัวสี่ขาที่ล่ามันซ้ำหลายรุ่นเรียนรู้แล้วว่าปุ่มที่หางเป็นของปลอม จึงมุ่งเจาะกลางวงม้วนตัวโดยตรงแทนเสมอ"
        },
        dangerDetail: {
        ...
        combat: [
            ...
            ["Pack Flip Vulnerability", "จุดอ่อนแท้จริงต้องถูกพลิกหงายโดยแรงภายนอกเท่านั้นถึงจะเผยออกมา ฝูงเจ้าตัวสี่ขาที่รู้ทันกลลวงแล้วใช้ตัวหนึ่งงัดพลิกพร้อมอีกตัวเจาะกลางวงม้วนตัวทันทีที่พลิกได้ ไม่สนใจปุ่มเรืองแสงที่หางเลย"]
        ],
        abilities: [
            {
                name: "การขุดหาด้วยสัมผัสใต้ดิน", type: "Sensory — การรับรู้ใต้ดิน",
                desc: "กรงเล็บที่ปลายขาหน้าจิกลงในดินโคลนแล้วดินเปิดออกง่ายราวกับเป็นน้ำ นำทางตรงไปยังรากอวบน้ำที่ฝังอยู่ข้างใต้โดยไม่ต้องเห็นหรือดมกลิ่นล่วงหน้าก่อนขุดเลยแม้แต่น้อย",
                origin: "ร่างที่หุ้มเกราะหนักและม้วนตัวป้องกันภัยได้สมบูรณ์แบบสามารถก้มหน้าขุดหากินได้นานเท่าที่ต้องการโดยไม่ต้องคอยระวังภัยตลอดเวลาแบบสัตว์อื่น ประสาทสัมผัสใต้ดินจึงพัฒนาให้แม่นยำจนแทบไม่ต้องใช้สายตาเลย เพราะไม่มีความจำเป็นต้องเงยหน้าดูรอบตัวบ่อยๆ เหมือนเหยื่อชนิดอื่น"
            },
            {
                name: "การหดตัวเข้าวงป้องกัน", type: "Defensive — การม้วนตัวฉับพลัน",
                desc: "เมื่อรับรู้ภัยคุกคาม กล้ามเนื้อทั่วตัวหดพร้อมกันในเสี้ยววินาที ดึงหัว ขา และหางม้วนเข้าหากันจนข้อต่อสันหลังล็อกเป็นวงกลมสนิท ไม่มีตำแหน่งใดในวงให้เขี้ยวสอดเข้าได้เลย",
                origin: "ร่างที่พึ่งการวิ่งหนีแทบไม่ได้เลยเพราะขาสั้นป้อมและเกราะหนัก จึงพัฒนาการหดตัวให้เป็นการป้องกันตัวหลักแทน — หดเร็วพอที่จะทันแม้ผู้ล่าที่พุ่งเข้าใส่แบบไม่ทันตั้งตัว แลกมาด้วยการที่กล้ามเนื้อชุดเดียวกันไม่เหลือแรงพอจะพลิกกลับคืนท่ายืนได้เองอีก"
            }
        ],
        notes: [
            ["", "<strong>บทเรียนของฝูง</strong>: ต่างจากร่างสี่ขาหรือเจ้าตาโตที่ล่าได้ด้วยตัวเดียว เจ้าก้อนหินกลมคือเหยื่อชนิดเดียวในป่าหมอกที่ฝูงเจ้าตัวสี่ขาต้อง 'วางแผน' ล่วงหน้าจริงๆ ก่อนลงมือ — แบ่งหน้าที่พลิกตัวกับเจาะจุดอ่อนอย่างชัดเจน ทั้งยังต้องรู้ทันกลลวงที่หางด้วย เป็นภาพการทำงานเป็นทีมและการเรียนรู้ข้ามรุ่นที่ต่างจากการไล่ต้อนเหยื่อวิ่งแบบปกติโดยสิ้นเชิง"],
