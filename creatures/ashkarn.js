/* ITH-216-330 — Ashkarn — ทดสอบ ALIEN INTENSITY SCALE Tier IV */
creaturesData.push({
        id: "ITH-216-330", name: "Ashkarn", nickname: "เจ้าหินที่ตื่น", status: "ALIVE", era: "ยุคป่าหมอก (Mistwood Era)",
        ...
        desc: "สิ่งมีชีวิตที่ใช้ชีวิตส่วนใหญ่หลอมรวมเป็นเนื้อเดียวกับหินบะซอลต์ในปล่องภูเขาไฟจนแยกไม่ออกจากหินจริง จำศีลลึกไปกับวัฏจักรการปะทุของภูเขาไฟที่มันฝังตัวอยู่ — ทุกๆ 40 ปีโดยประมาณ ภูเขาไฟลูกนั้นจะปะทุครั้งใหญ่และยังคุกรุ่นอาละวาดต่อเนื่องได้นานถึง 1 ปีเต็มก่อนฤดูฝนใหญ่ของ Ithra จะมาถึงและดับความร้อนลง เมื่อภูเขาไฟเริ่มเคลื่อนไหว ความร้อน/แรงสั่นสะเทือนจะปลุกให้เปลือกหินแตกออกและมันจึงตื่นล่า อาศัยความโกลาหลของฝูงสัตว์ที่หนีตายจากลาวาเป็นช่วงเวลาล่าเพียงช่วงเดียวในรอบหลายสิบปี ก่อนกลับไปจำศีลอีกครั้งเมื่อฝนใหญ่มาถึงและพื้นดินเย็นลง",
        ...
        mutationFull: {
            ...
            conDesc: "ไม่มีกลไกใดปลุกมันได้นอกจากความร้อน/แรงสั่นสะเทือนจากการปะทุจริงของภูเขาไฟลูกที่มันฝังตัวอยู่เท่านั้น ถ้าภูเขาไฟลูกนั้นดับสนิทถาวรและไม่ปะทุอีกเลย มันจะไม่มีวันตื่นขึ้นมาอีกต่อไป ไม่มีทางย้ายไปปล่องอื่นได้ด้วยตัวเอง และตราบใดที่ภูเขาไฟยังไม่สงบ (นานสุดเกือบ 1 ปีเต็มต่อรอบ 40 ปี) มันจะล่าต่อเนื่องไปตลอดทั้งช่วงนั้นโดยไม่กลับไปจำศีลก่อนกำหนดเลย"
        },
        dangerDetail: {
