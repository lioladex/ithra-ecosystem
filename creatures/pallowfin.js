...
creaturesData.push({
        ...
        habitat: "แหล่งน้ำ/พื้นที่ชุ่มน้ำ — The Resonant Strait และทุ่งสันทรายมหึมา รวมถึงหากินเข้าไปตามแผ่นดินได้ถึง Zone 8: The Sunken Grove ตอน Clash Tide และ Zone 13: The Weeping Cliffs",
        foodChain: "ผู้บริโภคปฐมภูมิของแหล่งน้ำ — ฐานอาหารหลักของเจ้าใต้เงาน้ำ",
        danger: "6% (Harmless)", size: "ระดับ 3 — เล็ก (เท่าปลาขนาดกลาง)", height: "ลำตัวยาว 42 ซม.", weight: "2.6 กก. (ต่อตัว)",
        desc: "สัตว์น้ำลำตัวแบนรวมฝูงหนาแน่นนับร้อยถึงหลายพันตัว กรองแพลงก์ตอนและอินทรียวัตถุจากน้ำตลอดเวลาที่ว่าย เป็นอาหารหลักของเจ้าใต้เงาน้ำและนักล่าน้ำอื่นๆ ฝูงจะเปลี่ยนทิศพร้อมกันอย่างฉับพลันเป็นแนวเดียวกันทั้งฝูงเมื่อพบภัย ราวกับเป็นสิ่งมีชีวิตเดียวกัน",
        ...
        combat: [
            ["วาบแสงสับสน (Confusion Flash)", "เมื่อถูกโจมตี ทั้งฝูงพลิกตัวสะท้อนแสงพร้อมกันเป็นวาบสว่างวูบเดียว ทำให้ผู้ล่าอย่างเจ้าใต้เงาน้ำเสียเป้าหมายชั่วขณะ"],
