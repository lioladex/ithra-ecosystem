...
creaturesData.push({
        ...
        social: "หวงถิ่นรุนแรง ล่าเดี่ยวเป็นหลัก อาณาเขตครอบคลุมเรือนยอดกว่า 100 ตร.กม. จะรวมฝูงชั่วคราว (3-5 ตัว) เฉพาะตอนเจอซากสัตว์ขนาดใหญ่ (เช่น ซากสัญชาตญาณที่ไม่เคยเห็นตัวในอดีต)",
        head: [
        ...
        mutationFull: {
            ...
            conDesc: "เพื่อให้ร่อนได้ กระดูกจึงสูญเสียความหนาแน่นไปเกือบหมด หากมันพลาดตกลงพื้นดิน หรือถูกสัตว์กินเนื้อภาคพื้นดิน (เช่น เจ้าตัวสี่ขา) ตะปบเพียงครั้งเดียว กระดูกมันจะหักร้าวทันที มันจึงหลีกเลี่ยงพื้นดินประดุจลาวาเดือด"
        },
        dangerDetail: {
        ...
        combat: [
            ["Gravity Drop", "โฉบจับเหยื่อขนาดกลาง (เช่น เจ้าตาโต หรือร่างสี่ขาวัยอ่อน) บินทะยานขึ้นฟ้า แล้วปล่อยทิ้งลงมากระแทกหินหรือกิ่งไม้ใหญ่ให้ตายก่อนลงมากิน"],
        ...
        abilities: [
            {
                name: "การได้ยินทิศทางในกะโหลก", type: "Sensory — การได้ยิน",
                desc: "ไม่มีใบหูภายนอก แต่โครงสร้างสะท้อนเสียงในกะโหลกให้ข้อมูลทิศทางของเสียงได้ในตัวเอง แม้ในความมืดสนิทที่ตาใช้งานไม่ได้เลย เสียงที่ 'ได้ยินในกะโหลก' ยังบอกทิศทางได้แม่นยำพอจะบินตามได้โดยไม่ต้องเห็น",
                origin: "นักล่าทางอากาศที่ต้องบินสูงเหนือหมอกทึบเป็นเวลานานไม่มีโอกาสพึ่งสายตาได้ตลอดเวลา วิวัฒนาการจึงย้ายภาระจากตาไปที่กะโหลกแทน — เป็นระบบที่ทำงานได้แม้ตาบอดสนิทในหมอก"
            },
            {
                name: "การอ่านกระแสลมร้อน", type: "Sensory — การบิน",
                desc: "รับรู้ขอบของกระแสลมร้อนที่ลอยขึ้นจากหมอกเบื้องล่างได้จากแรงยกที่ไม่เท่ากันระหว่างปีกซ้าย-ขวา แล้วไต่วนขึ้นไปตามกระแสนั้นได้อย่างแทบไม่ต้องออกแรง เป็นวิธีเดียวที่ร่างกระดูกกลวงอย่างมันจะลอยอยู่กลางอากาศได้นานหลายวันโดยแทบไม่กระพือปีก",
                origin: "กระดูกกลวงที่แลกมาด้วยความเปราะบางสุดขีดจะไร้ค่าถ้าต้องกระพือปีกตลอดเวลาเหมือนนกทั่วไป ประสาทสัมผัสที่อ่านลมร้อนได้แม่นยำจึงเป็นเงื่อนไขคู่กันที่ทำให้การแลกเปลี่ยนทางวิวัฒนาการนี้คุ้มค่าจริง"
            },
            {
                name: "การอาบแสงด้วยปีกแทนแผงคอ", type: "Cognitive — ความจำข้ามร่าง",
                desc: "ร่างนี้ไม่มีแผงรับแสงแบบร่างสี่ขาอีกต่อไป แต่แรงกระตุ้นให้ 'อาบแสงเพื่อฟื้นตัว' ยังอยู่ — กางปีกออกเข้าหาแสงแทน เผยให้เห็นร่างแหเส้นเลือดฝอยผ่านเยื่อปีกโปร่งแสง อุ่นเลือดโดยตรงผ่านปีกจนอาการชาที่ปลายปีกหายเร็วขึ้นอย่างเห็นได้ชัด",
                origin: "สัญชาตญาณเก่าจากร่างก่อนหน้าไม่ได้หายไปเปล่าๆ เมื่อร่างเปลี่ยน มันแค่หาอวัยวะใหม่ที่ใกล้เคียงที่สุดมาทำหน้าที่แทน — หลักฐานว่าความเข้าใจบางอย่างส่งผ่านข้ามร่างได้จริง ไม่ใช่แค่ทักษะที่ต้องเรียนใหม่ทุกครั้ง"
            }
        ],
        notes: [
            ["", "<strong>โจรแห่งป่าหมอก</strong> ฝูงเจ้าตัวสี่ขาเกลียดชังเจ้าเงาปีกกว้างเป็นอย่างมาก เพราะหลายครั้งที่เจ้าตัวสี่ขาไล่ต้อนเหยื่อจนเหนื่อยหอบและเพิ่งล้มเหยื่อได้ เจ้าเงาปีกกว้างจะโฉบลงมาจากฟ้าและคีบซากนั้นบินหนีไปต่อหน้าต่อตา"],
            ["warn", "<strong>เงามัจจุราชของร่างสี่ขา</strong> ในร่างของร่างสี่ขา (ตัวเอก) แม้ว่าจะระแวงเจ้าตัวสี่ขาบนพื้นป่า แต่สัญชาตญาณความกลัวที่ฝังลึกที่สุดเมื่ออยู่ใต้ช่องว่างของเรือนยอดไม้ คือเงาขนาดมหึมาที่พาดผ่านพื้นดิน สัญชาตญาณร่างสี่ขาจะสั่งให้ 'ยืนนิ่งและหยุดหายใจ' ทันทีเมื่อเห็นเงาของเจ้าเงาปีกกว้าง"]
        ],
        prompt: "A massive alien wyvern-like aerial apex predator-scavenger standing 2.2 meters tall with its wings folded, boasting an immense 8.5-meter wingspan when fully spread, deceptively light-framed with a deep keeled chest and a fully honeycombed hollow skeleton built for endless soaring. Its head bears four glowing sun-gold eyes: a forward-facing binocular pair for hunting from great height and a smaller downward-facing pair beneath them for scanning movement through the fog below, a sealed nostril groove that closes shut during high-speed dives or in the freezing upper air, and a toothless hooked bone beak with serrated blade-like edges built for tearing thick hide and tough sinew, gaping wide enough to swallow small bones whole. Its ears are internal aerodynamic sound-channels tuned to the frequency of a dying animal's cry rather than external flaps. A translucent solar-sail crest webbed with asymmetric, irregularly branching blood vessels — tracing more like mineral fracture lines than an animal's veins — flares from the back of its skull to catch sunlight and rapidly rewarm its blood after flights through bitterly cold high air, and an elastic gular throat pouch hangs beneath its chin, used to carry meat back to its young or to regurgitate concentrated digestive acid at any attacker that corners it. Its six-limbed body has a deep-keeled aerodynamic frame with tiny spiracle vents running along the spine that feed air directly into its flight muscles, tapering to a stiff tail ending in a diamond-shaped kite of skin that acts as a rudder in turbulent wind. It has three limb pairs: immense leathery wings spanning 8.5 meters, braced by three long fingers and a hooked thumb-talon for climbing canopy trunks; short but densely muscled grasping arms with three talons for pinning carrion in place while the beak tears; and long powerful legs ending in zygodactyl raptor feet that lock rigid onto branches even while asleep and snatch prey clean out of midair. Its wings and back are sheathed in taut, shark-like micro-scaled skin with a faint gem-like iridescent sheen when it catches direct light, structured in overlapping layers like cut mineral facets rather than ordinary scales, that silences the sound of air over its body, while its throat and underbelly are thick creased hide protecting its organs from canopy branches, and its arms and legs are armored in large reptilian scutes against a struggling prey's bite. Countershading splits its body cleanly: deep slate-blue-grey above to vanish against the canopy from a hunter's-eye view, pale fog-blue below to vanish against the sky from beneath. Its hollow honeycombed skeleton lets it ride thermal updrafts for days without a single wingbeat, at the cost of shattering instantly the moment it is struck or forced down onto solid ground. Its coloration is a harmonious cool slate-blue palette, deepened by near-black blue-grey shadows in the recesses and lifted by pale sky-blue highlights along the wing membranes, with rust-brown tones worked into the leg and arm-joint scales and dull crimson streaked along the wing membrane edges, and a glowing sun-gold highlight reserved only for its four eyes, the veins of its solar-sail crest and the serrated edge of its beak. It is caught in the instant of launching off a massive moss-covered branch high in the misty canopy, wings snapping open to full span against a blazing backlit sky, the sun burning directly behind it through drifting mist and reducing the canopy below to soft silhouette, its translucent wing membranes and crest glowing molten gold as the light pours straight through them, its four eyes catching a hard glint of sun-gold.\n\nPhotorealistic 3D creature render, cinematic film-VFX quality, full-body in its natural canopy habitat, three-quarter view, shot with a telephoto lens at eye level, harsh direct backlight blazing through drifting mist behind the subject, the canopy below reduced to soft silhouette, the translucent wing membranes and crest glowing molten gold as light pours through them, crisp hard rim lighting along its silhouette, hyper-sharp micro-detail texturing on every scale and surface, subsurface scattering, physically-based rendering, high-contrast natural color grading with a blown-out backlit sky, 1:1 square composition, subject centered and fully visible from head to feet, no readable text."
});
