...
creaturesData.push({
        ...
        habitat: "ป่าหมอกชั้นกลางต่อเนื่องพื้นดิน (Verath, Zone 2-3: The Mist Layer / The Dark Mire)",
        foodChain: "ผู้บริโภคทุติยภูมิขนาดเล็ก — ล่าฝูงแสงกะพริบและแมลงอื่น เป็นเหยื่อของสัตว์ปีกขนาดเล็กและเจ้าตัวสี่ขาวัยอ่อน",
        danger: "28% (Cautious)", size: "ระดับ 2 — เล็ก (เท่าแมวเล็ก)", height: "ลำตัวยาว 38 ซม. (ไม่รวมขา)", weight: "3.4 กก.",
        desc: "สัตว์ขาปล้องลำตัวยาวคล้ายตะขาบผสมแมงมุม ทอใยเหนียวขึงระหว่างช่องว่างลำต้นไม้เพื่อดักฝูงแสงกะพริบ เคลื่อนไหวเงียบกริบและแทบไม่ใช้สายตา อาศัยขนรับแรงสั่นสะเทือนไวสุดขั้วทั่วลำตัวในการระบุตำแหน่งเหยื่อที่ติดใยได้แม่นยำโดยไม่ต้องเห็น",
        ...
        social: "อยู่ตัวเดียว หวงพื้นที่ใยของตัวเอง สร้างใยใหม่ทุก 2-3 คืนตามเส้นทางฝูงแสงกะพริบที่เปลี่ยนไป",
        head: [
            ...
            ["จมูก", "ไม่มีจมูก มีก้านรับสารเคมีคู่หน้า", "ก้านสัมผัส (Palps) สั้นสั่นตลอดเวลา รับกลิ่นฟีโรโมนและสารเคมีจากปีกแมลงที่ติดใย บอกได้ว่าเป็นฝูงแสงกะพริบหรือแมลงชนิดอื่น"],
            ...
            ["EXTRA #1", "ต่อมทอใยที่ปลายท้อง (Spinnerets)", "รังไหมเหนียวพิเศษ ทอเป็นเส้นใยขึงระหว่างช่องว่างต้นไม้เป็นร่างแหดักฝูงแมลงบิน เหนียวพอจะหยุดฝูงแสงกะพริบที่บินเร็วได้ทันที"],
        ...
        combat: [
            ["ทอใยดักล่วงหน้า (Web Ambush)", "ขึงใยเหนียวระหว่างช่องว่างต้นไม้ตามเส้นทางที่ฝูงแสงกะพริบมักบินผ่าน แล้วหมอบนิ่งรอข้างใยเป็นเวลานานหลายชั่วโมงโดยไม่ขยับ"],
