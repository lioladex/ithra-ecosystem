...
creaturesData.push({
        ...
        abilities: [
            ...
            },
            {
                ...
                desc: "เมื่อล้อมเหยื่อที่มีการป้องกันตัวเฉพาะทาง (เช่น Ozgrun ที่ม้วนตัวเป็นเกราะ) ฝูงแบ่งหน้าที่กันชัดเจนในจังหวะเดียวกันโดยไม่ต้องมีสัญญาณสั่งซ้ำ: สองตัวแยกออกอ้อมไปคนละทางจนถึงตำแหน่งเท่ากันพอดี ตัวกลางออกตัวตั้งแต่เหยื่อเพิ่งเริ่มขยับไม่ใช่รอให้เสร็จสมบูรณ์ก่อน และสองตัวที่งัดจุดอ่อนไม่ปล่อยทันทีที่เจาะสำเร็จแต่ยังค้ำไว้จนแน่ใจว่าจบแล้ว — สามบทบาทที่ต้องแม่นทั้งจังหวะและตำแหน่งพร้อมกันในคราวเดียว",
                origin: "เหยื่อที่มีเกราะป้องกันตัวสมบูรณ์แบบอย่าง Ozgrun เจาะไม่ได้เลยด้วยตัวเดียวหรือฝูงที่ประสานงานไม่พอ แรงกดดันจากเหยื่อที่ 'แพง' ที่สุดในป่าหมอกจึงคัดเลือกให้ฝูงที่แบ่งบทบาทได้แม่นยำที่สุดอยู่รอด ส่วนฝูงที่ยังล่าแบบรุมพร้อมกันไม่มีระเบียบจะไม่มีทางเจาะเกราะได้เลย"
            }
        ],
        confusion: [
