...
creaturesData.push({
        ...
        category: "สัตว์กินเนื้อ · นักล่าฝูงรับความร้อน (Thermoreceptive pack-hunter)", habitat: "ป่าหมอกชั้นพื้นดิน (Verath, Zone 3: The Dark Mire) — บางฝูงยังไล่ต้อนเหยื่อเข้า Zone 12: The Bramble Maze และเคยพบผ่าน Zone 7: The Ashfall Scar ตอนหนีภัยภูเขาไฟ",
        foodChain: "ผู้ล่าระดับสูงของชั้นพื้นดิน — ล่าร่างสี่ขาเป็นอาหารหลัก",
        danger: "48% (Dangerous) - ต่อ 1 ตัว", size: "ระดับ 4 — กลาง (เท่าสุนัขใหญ่)", height: "0.95 ม. ที่ไหล่", weight: "58 กก.",
        desc: "นักล่าฝูงที่โจมตีร่างสี่ขาในฉากตื่นรู้ ล่าด้วยการต้อนให้เหยื่อวิ่งจนตัวร้อน สื่อสารกันในฝูงด้วยแถบเรืองแสงข้างแก้ม มีระบบตาสองชั้น (ภาพปกติ + รังสีความร้อน)",
        ...
        combat: [
            ["การล่าแบบ \"ไล่ให้ร้อน\"", "เจ้าตัวสี่ขาไม่จู่โจมทันที แต่ไล่ต้อนเหยื่อให้วิ่งจนอุณหภูมิร่างกายสูงขึ้น เพราะเหยื่อที่ร้อนจะสว่างขึ้นในสายตาของมัน ยิ่งเหยื่อวิ่งหนีนานเท่าไหร่ มันก็ยิ่งมองเห็นชัดขึ้นเท่านั้น"],
        ...
        abilities: [
            ...
            },
            {
                ...
                origin: "ผูกตรงกับร่างสี่ขาที่ต้องอาบแสงจนตัวอุ่นเพื่อดำรงชีวิต — พฤติกรรมที่หล่อเลี้ยงชีวิตร่างสี่ขาคือสัญญาณเดียวกับที่เรียกเจ้าตัวสี่ขามาหาแบบเจาะจง ไม่ใช่เรื่องบังเอิญ แต่เป็นแรงกดดันวิวัฒนาการที่ผลักทั้งสองสายพันธุ์ให้ล็อกกันแบบนี้มานานนับล้านปี"
            },
            {
                ...
                origin: "หลักฐานชัดเจนที่สุดคือปุ่มเรืองแสงลวงเป้าที่หางของเจ้าก้อนหินกลม — กลลวงที่เคยได้ผลกับเจ้าตัวสี่ขาตัวเดียวโดดๆ ในอดีต แต่ฝูงที่ล่าเจ้าก้อนหินกลมซ้ำมาหลายรุ่นรู้ทันแล้วว่าปุ่มนั้นเป็นของปลอม จึงมุ่งเจาะกลางวงม้วนตัวตรงๆ ไม่สนใจปุ่มที่หางอีกต่อไป — เป็นความรู้ที่ไม่มีตัวใดตัวหนึ่งเคยพิสูจน์เองในชีวิตเดียว แต่ทั้งฝูงรู้ร่วมกัน"
            },
            {
                name: "การแบ่งบทบาทในการล้อม", type: "Hunting Tactic — กลยุทธ์การล่า",
                desc: "เมื่อล้อมเหยื่อที่มีการป้องกันตัวเฉพาะทาง (เช่นเจ้าก้อนหินกลมที่ม้วนตัวเป็นเกราะ) ฝูงแบ่งหน้าที่กันชัดเจนในจังหวะเดียวกันโดยไม่ต้องมีสัญญาณสั่งซ้ำ: สองตัวแยกออกอ้อมไปคนละทางจนถึงตำแหน่งเท่ากันพอดี ตัวกลางออกตัวตั้งแต่เหยื่อเพิ่งเริ่มขยับไม่ใช่รอให้เสร็จสมบูรณ์ก่อน และสองตัวที่งัดจุดอ่อนไม่ปล่อยทันทีที่เจาะสำเร็จแต่ยังค้ำไว้จนแน่ใจว่าจบแล้ว — สามบทบาทที่ต้องแม่นทั้งจังหวะและตำแหน่งพร้อมกันในคราวเดียว",
                origin: "เหยื่อที่มีเกราะป้องกันตัวสมบูรณ์แบบอย่างเจ้าก้อนหินกลมเจาะไม่ได้เลยด้วยตัวเดียวหรือฝูงที่ประสานงานไม่พอ แรงกดดันจากเหยื่อที่ 'แพง' ที่สุดในป่าหมอกจึงคัดเลือกให้ฝูงที่แบ่งบทบาทได้แม่นยำที่สุดอยู่รอด ส่วนฝูงที่ยังล่าแบบรุมพร้อมกันไม่มีระเบียบจะไม่มีทางเจาะเกราะได้เลย"
            }
        ],
        confusion: [
