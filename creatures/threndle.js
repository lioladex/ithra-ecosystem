...
creaturesData.push({
        ...
        notes: [
            ...
            ["warn", "<strong>ราคาของการเชี่ยวชาญ</strong>: ความเชี่ยวชาญในน้ำแลกมาด้วยการเป็นสัตว์ที่อ่อนแอที่สุดในเขตของตัวเองทันทีที่น้ำลด ทุ่งสันทรายมหึมาที่จมอยู่ใต้น้ำลึกหลายเมตรตอนน้ำขึ้น จะแห้งขอดกลายเป็นโคลนเลนราบเรียบภายใน 12 ชั่วโมง Threndle ที่คำนวณจังหวะผิดพลาดอาจติดอยู่บนบกแห้งจนตาย"],
