...
creaturesData.push({
        ...
        habitat: "พื้นป่าหมอก/หนองบึง (Verath, Forest Floor — Zone 3: The Dark Mire)",
        foodChain: "ผู้ย่อยสลาย — เก็บกินซากที่เหลือจากเจ้าตัวสี่ขา เจ้าเงาปีกกว้าง และนักล่าอื่น",
        ...
        mutationFull: {
            ...
            proDesc: "เปลือกเชื้อราที่ปกคลุมทั้งตัวมีรสขมจัดและสปอร์ระคายเคืองเมื่อถูกกัด นักล่าแทบทุกชนิดเรียนรู้จากประสบการณ์เพียงครั้งเดียวและเลี่ยงตลอดไป ทำให้เจ้าท่อนไม้เดินได้ไม่จำเป็นต้องมีความเร็ว ความแข็งแรง หรือประสาทสัมผัสที่ดีเลยก็สามารถอยู่รอดได้",
            conTitle: "ระบบเผาผลาญ / ความเร็วในการเคลื่อนที่",
            conDesc: "เพื่อรักษาพลังงานไว้สำหรับผลิตสารพิษและเปลือกหนา ระบบเผาผลาญและกล้ามเนื้อทำงานช้ามากอย่างถาวร แทบไม่มีความสามารถในการหนีภัยใดๆ เลย หากเจอสัตว์ที่ดื้อต่อพิษหรือรู้จุดพลิกตัวคว่ำ เจ้าท่อนไม้เดินได้แทบไม่มีทางป้องกันตัวเองได้อีกเลย"
        },
        dangerDetail: {
        ...
        notes: [
            ["", "<strong>ผู้เก็บกวาดที่ไม่มีใครอยากยุ่งด้วย</strong>: เจ้าท่อนไม้เดินได้มีบทบาทสำคัญที่สุดในวงจรสารอาหารของป่าหมอกทั้งระบบ แต่แทบไม่มีใครสังเกตเห็นมันเลย เพราะความช้าและการพรางตัวที่แนบเนียนจนแยกไม่ออก"],
