...
creaturesData.push({
        ...
        notes: [
            ["", "<strong>ผู้เก็บกวาดที่ไม่มีใครอยากยุ่งด้วย</strong> — Dunkrell มีบทบาทสำคัญที่สุดในวงจรสารอาหารของป่าหมอกทั้งระบบ แต่แทบไม่มีใครสังเกตเห็นมันเลยเพราะความช้าและการพรางตัวที่สมบูรณ์แบบ"],
            ["", "ลักษณะที่ตั้งใจไว้เบื้องต้น: เคลื่อนไหวเชื่องช้ามาก เปลือกคล้ายเชื้อรามีพิษอ่อน สำคัญต่อวงจรสารอาหารของทั้งป่า — ออกแบบระบบ Slot เต็มรูปแบบแล้ว"]
        ],
