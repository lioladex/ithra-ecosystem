...
creaturesData.push({
        ...
        habitat: "ป่าหมอกชั้นเรือนยอด (Verath, Zone 1: The Inner Canopy)",
        foodChain: "ผู้บริโภคปฐมภูมิของชั้นเรือนยอด — เหยื่อหลักของเจ้าเงาปีกกว้างและนักล่าอื่นๆ",
        danger: "15% (Harmless)", size: "ระดับ 3 — เล็ก (เท่าแมวป่าตัวใหญ่)", 
        height: "0.45 ม. ที่ไหล่ · ลำตัวยาว 0.7 ม. (ไม่รวมหาง)", weight: "12 กก.",
        desc: "นักยิมนาสติกแห่งป่าหมอก สัตว์เลี้ยงลูกด้วยนมกึ่งสัตว์เลื้อยคลานที่ใช้ชีวิตทั้งหมดบนกิ่งไม้ขนาดยักษ์ มีความว่องไวสูงมาก อาหารหลักคือยอดไม้อ่อนและน้ำหวานจากดอกไม้เรือนยอด เป็นเหยื่ออันดับหนึ่งของเจ้าเงาปีกกว้างจึงวิวัฒนาการประสาทสัมผัสและกล้ามเนื้อเพื่อหลบหลีกการโจมตีจากท้องฟ้าโดยเฉพาะ",
        ...
        head: [
            ...
            ["หู", "หูยาวปลายมน พับแนบหัวได้", "หมุนได้ 180 องศา ไวต่อเสียงแหวกอากาศของปีกเจ้าเงาปีกกว้าง หากได้ยินเสียงลมเปลี่ยนทิศ จะทิ้งตัวลงล่างทันที"],
        ...
        mutationFull: {
            ...
            proDesc: "วิวัฒนาการโครงสร้างระดับไมโครที่ปลายนิ้วแบบเดียวกับสัตว์เลื้อยคลาน ทำให้มันวิ่งสวนแรงโน้มถ่วง หรือห้อยหัววิ่งใต้กิ่งไม้ยักษ์ได้สบายๆ เป็นทริคหลักในการหลบหลีกกรงเล็บของเจ้าเงาปีกกว้างที่โฉบมาจากด้านบน",
        ...
        dangerDetail: {
            ...
            note: "สำหรับมนุษย์หรือนักล่าอื่นๆ เจ้าตาโตไม่มีอันตรายใดๆ เลย มันคือขนมขบเคี้ยวที่วิ่งเร็วมากของป่าเรือนยอด อาศัยเพียงความเร็วและการพรางตัวในการเอาชีวิตรอด"
        },
        combat: [
