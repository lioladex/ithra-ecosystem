        ...
        abilities: [
            {
                ...
                origin: "ไม่มีอาวุธหรือแรงสู้ใดๆ เลย ความอยู่รอดทั้งหมดของมันจึงขึ้นอยู่กับการไม่ถูกจับตัวได้ตั้งแต่แรก แรงกดดันจาก Skyther ที่โฉบจากฟ้าคัดสายพันธุ์ให้เหลือแต่ตัวที่ตอบสนองเร็วกว่าจังหวะที่นักล่ามองเห็นมันจริง"
            }
        ],
        notes: [
