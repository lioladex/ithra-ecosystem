        ...
        abilities: [
            {
                ...
                desc: "หูข้างใหญ่หมุนกวาดหาทิศเสียงตลอดเวลาขณะหูข้างเล็กหมอบแนบหัวลดพื้นที่ให้เห็นตัวยาก ส่วนกลีบจมูกที่บานได้ตามรอยทิศที่ Korrune จากไปและแยกความเข้มข้นของกลิ่นได้ว่าผ่านไปนานแค่ไหน — ไม่เข้าใกล้ซากจนกว่าจะมั่นใจว่าเจ้าของซากไปไกลจริงแล้วเท่านั้น",
