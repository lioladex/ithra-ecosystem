...
creaturesData.push({
        ...
        foodChain: "ยอดสุดของห่วงโซ่อาหารในยุคปัจจุบัน — ล่าได้แม้กระทั่งฝูงเจ้าตัวสี่ขาเต็มฝูง",
        danger: "92% (Apex Predator)", size: "ระดับ 6 — ใหญ่มาก (ใหญ่กว่าเจ้าตัวสี่ขามาก แต่เล็กกว่าสัญชาตญาณที่ไม่เคยเห็นตัว)", height: "2.4 ม. ที่ไหล่ · 4.6 ม. ยาวรวมหาง", weight: "2,100 กก.",
        desc: "นักล่าเดี่ยวที่หายากที่สุดในป่าหมอก พบเห็นได้น้อยมากเพราะประชากรต่ำและครองอาณาเขตกว้างมหาศาล ไม่มีสัตว์ชนิดใดในยุคปัจจุบันไล่ล่ามันได้ แม้แต่ฝูงเจ้าตัวสี่ขายังต้องหลบหนีเมื่อกลิ่นของมันลอยมาตามลม เชื่อกันว่าสืบเชื้อสายมาจากสัตว์กลุ่มเดียวกับที่รอดจากฤดูหนาวใหญ่ในยุคหมุนเวียน สายเลือดเดียวกับเจ้าขนน้ำแข็ง",
        ...
        head: [
            ...
            ["จมูก", "จมูกยาวไวต่อกลิ่นสุดขั้ว", "ดมกลิ่นฝูงเจ้าตัวสี่ขาได้ไกลเป็นกิโลเมตรก่อนเห็นตัว เป็นเหตุผลที่ฝูงเจ้าตัวสี่ขามักหนีไปก่อนที่จะเจอหน้ากันจริงๆ"],
            ...
            ["EXTRA #1", "ต่อมกลิ่นเตือนภัยข้างขากรรไกร", "ปล่อยกลิ่นเฉพาะตัวที่สัตว์แทบทุกชนิดในป่าหมอกจดจำและหวาดกลัวได้โดยสัญชาตญาณโดยไม่ต้องเคยเจอตัวมันมาก่อน — เป็นกลไกที่ทำให้ฝูงเจ้าตัวสี่ขาทั้งฝูงหนีได้โดยไม่ต้องเห็นตัว"],
        ...
        body: [
            ["BODY FRAME", "โครงแมวใหญ่ยืดยาวล่ำสัน", "อกลึก หลังยืดหยุ่นสูง สร้างมาเพื่อหมอบคลานต่ำและพุ่งกระโจนระยะสั้นด้วยแรงระเบิด ไม่ใช่ไล่ล่าทางไกลแบบเจ้าตัวสี่ขา"],
        ...
        dangerDetail: {
            ...
            note: "คะแนนอันตรายสูงที่สุดในบันทึกยุคป่าหมอกทั้งหมด สูงกว่าเจ้าตัวสี่ขาทั้งฝูงและเทียบเท่าระดับที่สัญชาตญาณที่ไม่เคยเห็นตัวเคยครองในยุคหมุนเวียน ต่างกันตรงที่เจ้าไร้เสียงไม่จำเป็นต้องอวดแสนยานุภาพเลย เพราะแทบไม่มีใครเคยเห็นมันมาก่อนที่จะตาย"
        },
        combat: [
        ...
        abilities: [
            {
                ...
                desc: "ขนดูดกลืนเสียงและแสงจนตัวขนาดใหญ่กว่าฝูงเจ้าตัวสี่ขาทั้งฝูงรวมกันเคลื่อนผ่านใบไม้แห้งได้โดยไม่มีแม้แต่ใบเดียวส่งเสียง แม้ตอนเดินจากไปหลังกินอิ่มก็ยังคงเงียบสนิทเหมือนเดิมทุกก้าว",
            ...
            },
            {
                ...
                origin: "นักล่าซุ่มทั่วไปมักตอบสนองต่อสิ่งที่ใกล้ที่สุดหรือเคลื่อนไหวชัดที่สุด แต่เจ้าไร้เสียงแทบไม่มีคู่แข่งหรือภัยคุกคามใดๆ ในป่าหมอกเลย พฤติกรรมประเมินเป้าหมายก่อนตัดสินใจจึงมีที่ว่างให้พัฒนาได้เต็มที่ ไม่ต้องรีบตอบสนองแบบสัญชาตญาณดิบเหมือนนักล่าที่ยังมีคู่แข่ง"
            }
        ],
        notes: [
            ["warn", "<strong>ช่องว่างของห่วงโซ่อาหารที่เพิ่งอุดได้</strong> ก่อนหน้านี้เจ้าตัวสี่ขาเป็นนักล่าที่มีคะแนน Danger สูงสุดในยุคปัจจุบันเพียงระดับ \"Dangerous\" (48%) เท่านั้น ไม่ใช่ Apex ตัวจริง เจ้าไร้เสียงคือคำตอบของตำแหน่งยอดห่วงโซ่ที่ระบบนิเวศยุคป่าหมอกยังขาดอยู่"],
            ["", "<strong>สายเลือดผู้รอดชีวิต</strong> เชื่อกันว่าเจ้าไร้เสียงสืบเชื้อสายมาจากกลุ่มสัตว์มีขนหนาชนิดเดียวกับที่รอดพ้นฤดูหนาวใหญ่ในยุคหมุนเวียน สายเลือดเดียวกับ <em style='color:var(--accent-default)'>เจ้าขนน้ำแข็ง</em> แห่งทวีป Kessara แต่วิวัฒนาการไปคนละทิศทางเมื่อกลับมาสู่ป่าที่อบอุ่นชื้นแฉะ"],
