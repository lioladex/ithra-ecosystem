...
creaturesData.push({
        ...
        desc: "สิ่งมีชีวิตห้อยคลุมกิ่งไม้ยักษ์เป็นผืนเยื่อหนาชื้นตรงรอยต่อระหว่างเรือนยอดกับชั้นหมอกกลาง จุดที่แสงจาก Ashvel กระจายผ่านหมอกลงมาพอดี ผิวโปร่งแสงเผยเห็นร่างแหท่อลำเลียงของเหลวสีทองเต้นเป็นจังหวะช้าๆ อยู่ใต้ผิว คล้ายเห็นเส้นเลือดเต้นผ่านผิวหนังบาง ไม่มีราก ไม่ล่าเหยื่อ ดำรงชีวิตด้วยการดูดซับแสงและความชื้นในอากาศผ่านกลุ่มรูหายใจที่คอยหุบ-ขยายทั่วผืนอยู่ตลอดเวลา เคลื่อนที่ได้ช้ามากด้วยระบบยึดเกาะที่ค่อยๆ คืบคลานหาจุดรับแสงที่ดีกว่าเป็นสัปดาห์ๆ คือแหล่งอาหารหลักที่แท้จริงที่ Luvenn ปีนขึ้นไปแทะกินเมื่อแสงถึงพื้นป่าไม่พอ",
        mutation: { pro: "ดำรงชีวิตด้วยแสงและความชื้นล้วนๆ / ไม่ต้องล่าหรือแข่งขันกับใครเลย", con: "เคลื่อนที่ได้ช้ามากจนแทบนับว่านิ่ง / ถูกกินเป็นฝูงจาก Luvenn ได้ง่ายโดยไม่มีทางหนีเลยแม้แต่น้อย" },
        ...
        notes: [
            ["", "<strong>ปริศนาที่เพิ่งไขได้</strong>: บันทึกเดิมของ Luvenn เคยระบุเพียงว่ามัน 'กินแสงและความชื้น' โดยไม่มีแหล่งอาหารที่ชัดเจน — Lumenveil คือคำตอบ: มันคือพืชที่ Luvenn ปีนขึ้นเรือนยอดต่ำเพื่อแทะกินเวลาแสงที่พื้นป่าไม่พอ อธิบายได้ว่าทำไม Luvenn ถึงยังมีแผงรับแสงที่วิวัฒนาการมาสำหรับ 'สังเคราะห์แสงเสริม' ได้พอดี ไม่ใช่กลไกเดียวที่เลี้ยงร่างกายทั้งหมด"],
            ["", "<strong>ผู้เชื่อมสองชั้นป่า</strong>: ผืน Lumenveil ที่แผ่ขยายจนเชื่อมกันเป็นสะพานธรรมชาติระหว่างกิ่งไม้ยักษ์ บางครั้งกลายเป็นทางเดินให้ Vashli ข้ามกิ่งโดยไม่ต้องกระโดดเสี่ยงตกเลย"]
        ],
