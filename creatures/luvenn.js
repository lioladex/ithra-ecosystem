...
creaturesData.push({
        ...
        pattern: "เส้นใบ (venation) สีอ่อนแตกแขนงบนเกล็ดและริ้วครีบทุกแผ่นทั่วทั้งตัว ให้ความรู้สึกคล้ายใบไม้โดยไม่ลอกทรงใบไม้จริงตรงๆ ยังคงความเป็นเอเลี่ยน เข้มที่สุดบนแผงรับแสงและจางลงตามลำตัว — ยามสังเคราะห์แสงเต็มที่ เส้นใบบนแผงรับแสงจะเรืองแสงเขียวมรกตอ่อนๆ มองเห็นได้ในที่ร่ม",
