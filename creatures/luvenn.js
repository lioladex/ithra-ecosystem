...
creaturesData.push({
        ...
        category: "ผู้ผลิต (สังเคราะห์แสง) · สัตว์กินแสงสี่ขา (Quadrupedal photosynthetic grazer)", habitat: "ป่าหมอกชั้นกลาง (Verath, Zone 2: The Mist Layer)",
        foodChain: "ผู้ผลิตและผู้บริโภคปฐมภูมิ — เหยื่อหลักของเจ้าตัวสี่ขา",
        ...
        abilities: [
            ...
            },
            {
                ...
                origin: "ฝูงที่รอดจากเจ้าตัวสี่ขาได้คือฝูงที่ไม่มีจุดอ่อนให้ผู้ล่าเลือกจู่โจมง่ายๆ พฤติกรรมปรับตำแหน่งให้สมาชิกอ่อนแอที่สุดอัตโนมัติจึงฝังลึกกว่าการตัดสินใจของตัวใดตัวหนึ่ง เป็นกลไกที่ทำงานได้แม้ไม่มีใครในฝูง 'รู้ตัว' ว่ากำลังช่วยเหลือใครอยู่"
            },
            {
