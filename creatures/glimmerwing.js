...
creaturesData.push({
        ...
        notes: [
            ["warn", "<strong>ดาบสองคมของร่างสี่ขา</strong>. แสงของฝูงแสงกะพริบที่บินตอมแผงคอร่างสี่ขาช่วยให้ภาพดูสวยงามและบอกจุดที่มีแหล่งอาหาร แต่ในคืนที่มืดมิด แสงสีฟ้าเหล่านี้คือเป้าหมายที่ฝูงเจ้าตัวสี่ขาตามมาล่าได้อย่างง่ายดาย"]
        ],
