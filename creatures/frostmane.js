...
creaturesData.push({
        ...
        mutationFull: {
            ...
            proDesc: "ระบบกักเก็บความร้อนสามชั้น (ขนสองชั้น, โหนกไขมันสะสมพลังงาน, โพรงจมูกอุ่นอากาศก่อนถึงปอด) ทำงานร่วมกันจนทนความหนาวจัดที่สุดในบันทึกทั้งหมดของ Ithra ได้ เป็นตัวอย่างสิ่งมีชีวิตที่ปรับตัวรอดจากฤดูหนาวใหญ่ได้สำเร็จอย่างสมบูรณ์",
        ...
        notes: [
            ...
            ["", "ลักษณะที่ตั้งใจไว้เบื้องต้น: ขนหนามาก ทนหนาวสุดขั้ว อยู่รวมฝูงใหญ่ — ออกแบบระบบ Slot เต็มรูปแบบแล้ว"]
        ],
