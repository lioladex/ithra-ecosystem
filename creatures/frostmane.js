...
creaturesData.push({
        ...
        head: [
            ...
            ["EXTRA #1", "เขาโค้งคู่หน้าสะสมน้ำแข็งจริง (Ice-fused Snow-plow Horns)", "เขาแข็งหนาโค้งลงด้านหน้าไม่สมมาตรกันเล็กน้อยตามข้างที่ถนัดพลั่วหิมะ ผิวเขาโปร่งแสงคล้ายน้ำแข็งอัดแน่น และมีก้อนน้ำแข็งจริงงอกฝังแทรกอยู่ในเนื้อเขาสะสมมากขึ้นเรื่อยๆ ตามอายุ — เขาของตัวที่แก่มากจึงมีก้อนน้ำแข็งฝังเป็นริ้วเห็นชัดกว่าตัวหนุ่ม เป็นเครื่องมือหากินหลักมากกว่าอาวุธ"],
            ...
            ["EXTRA #3", "ร่างแหเส้นเลือดเรืองแสงใต้ขน (Vestigial Bioluminescent Veins)", "ใต้ขนหนาสองชั้นมีร่างแหเส้นเลือดฝอยเรืองแสงจางสีขาวอมฟ้าซ่อนอยู่ทั่วตัว — ร่องรอยที่หลงเหลือจากบรรพบุรุษร่วมกับ Korrune ปกติมองไม่เห็นเลยเพราะขนบังหนา เห็นจางๆ ได้เฉพาะจุดที่ขนเปียกแบนราบหรือบางลงจากการเสียดสีเท่านั้น ไม่มีหน้าที่ใช้งานจริงในสายพันธุ์นี้อีกต่อไป"]
        ],
        body: [
        ...
        hlAt: "ดวงตาสีอำพันทองอุ่นตัดกับขนขาวทั้งตัว · เกล็ดน้ำแข็งเกาะปลายขนแผงคอเมื่อต้องแสง · ก้อนน้ำแข็งฝังในเนื้อเขาเป็นริ้ว · ร่างแหเส้นเลือดเรืองแสงจางที่เห็นเฉพาะจุดขนเปียกแบน",
        mutationFull: {
