...
creaturesData.push({
        ...
        category: "สัตว์กินเนื้อ · นักล่าลำดับรองแบบซุ่มขุด (Mesopredator, ambush burrower) — Alien Intensity Tier II", habitat: "ทุ่งหินตะกอนโล่งแจ้งเชิงเทือกเขา Sorn (Zone 4: The Sorn Rift & Sedimentary Flats)",
        danger: "41% (Dangerous)", size: "ระดับ 4 — กลาง (เท่าสุนัขใหญ่)", height: "0.85 ม. ที่ไหล่", weight: "68 กก.",
        desc: "นักล่าลำดับรองที่ตกเป็นเหยื่อประจำของสัญชาตญาณที่ไม่เคยเห็นตัว ขุดโพรงซุ่มและพุ่งแทงจากด้านล่าง ยังคงเดิน 4 ขา ขนาดใกล้เคียงเจ้าตัวสี่ขาตามหมายเหตุเฉพาะตัว (จุดที่ทำให้สัญชาตญาณเก่าของตัวเอกสับสนในฉากตื่นรู้) แต่หาง/พื้นผิวปรับให้เอเลี่ยนเข้มข้นขึ้นแล้ว",
        ...
        social: "ล่าเดี่ยวหรือเป็นคู่ ยึดอาณาเขตโพรงของตัวเอง ก้าวร้าวต่อเจ้าเงาที่คุ้นเคยตัวอื่นที่รุกล้ำ",
        head: [
        ...
        body: [
            ["BODY FRAME", "โครงสี่ขาลำตัวลึก อกกว้างเอวคอด", "ให้เงาร่างของนักล่าสี่ขาอย่างชัดเจน — ขนาด/ท่าทาง/จำนวนขาตรงกับเจ้าตัวสี่ขาตามหมายเหตุเฉพาะตัว ลำตัวหนาแน่นแต่ยืดหยุ่นพอจะบิดตัวในโพรงแคบได้"],
        ...
        skin: [
            ...
            ["ไหล่/สันหลัง", "ขนหยาบยาวกว่าส่วนอื่น เป็นแผงหนาปกป้องบริเวณที่มักถูกกัดจากด้านบน เส้นขนกลวงมีแกนใสจางแซมเส้นแร่ผลึกเล็กๆ คล้ายตระกูลเดียวกับเจ้าตัวสี่ขาแต่ไม่เรืองแสง — จุดที่ Apex Predator มักโจมตีเป็นอันดับแรก"],
        ...
        pattern: "ลายจุดกระจายสีเข้มบนพื้นน้ำตาลเทา หนาแน่นที่สุดบริเวณสีข้างและสะโพก จางลงที่ใต้ท้อง เลียนแบบลายเงาก้อนหินกระจายบนพื้นทุ่ง แทรกด้วยลายสวิลล์คริสตัลบางๆ รอบหนามจมูกและปลายหางแฉก มีแถบสีอ่อนพาดขวางสะโพกสองแถบ ใช้แสดงอาณาเขตต่อเจ้าเงาที่คุ้นเคยตัวอื่น",
        ...
        dangerDetail: {
            ...
            note: "เจ้าเงาที่คุ้นเคยอันตรายต่อสัตว์ขนาดเล็กและกลางอย่างมาก และสามารถทำให้นักล่าที่ใหญ่กว่าบาดเจ็บสาหัสได้หากถูกต้อนจนมุม แต่ต่อ Apex Predator ประจำถิ่นที่ไล่ล่าทางไกลได้ มันแทบไม่มีทางสู้เลย เพราะจุดแข็งทั้งหมดของมันคือการซุ่มโจมตีระยะประชิด"
        },
        combat: [
        ...
        extinction: {
            ...
            why: [
                ...
                "แข่งขันกับผู้ล่าชั้นใหม่ไม่ได้ — สิ่งมีชีวิตที่ปรับตัวเข้ากับป่าหมอกได้ (บรรพบุรุษของเจ้าตัวสี่ขา) เข้ามาแทนที่ตำแหน่งนักล่าลำดับรองในระบบนิเวศใหม่นี้"
            ],
            irony: "เจ้าเงาที่คุ้นเคยสูญพันธุ์เพราะโลกที่มันอยู่เปลี่ยนไป ไม่ใช่เพราะถูกล่าจนหมด — แต่รูปลักษณ์ของมันกลับหลอกหลอนระบบนิเวศใหม่ต่อไปอีก 40 ล้านปี ผ่านสัญชาตญาณที่ฝังอยู่ในตัวเอก"
        },
        notes: [
            ["", "<strong>redesign 2026-09-01</strong>: ปรับจาก Tier I เป็น Tier II (Heavily Alien) หลังยกเลิกกฎ Silhouette Lock — หมายเหตุเฉพาะตัวที่ต้องรักษาไว้คือ \"เดิน 4 ขา เป็นนักล่า ขนาดใกล้เคียงเจ้าตัวสี่ขา\" เท่านั้น ส่วนหางและพื้นผิวจึงปรับให้เข้มข้นขึ้นได้ (หางแยกแฉกคล้ายหนวด + ผิวคริสตัล/ออบซิเดียนสวิลล์) โดยไม่กระทบ silhouette หลักที่ทำให้สัญชาตญาณสับสนกับเจ้าตัวสี่ขาได้"],
