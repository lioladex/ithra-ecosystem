...
creaturesData.push({
        ...
        habitat: "ชั้นหมอกกลาง (Verath, Zone 2: The Mist Layer)",
        foodChain: "ผู้บริโภคทุติยภูมิขนาดเล็ก — ล่าแมลงและฝูงแสงกะพริบ เป็นเหยื่อฉวยโอกาสของนักล่าที่ไม่ทันสังเกตลายเลียนแบบ",
        ...
        desc: "สัตว์กลางคืนขนาดจิ๋วที่วิวัฒนาการลายเรืองแสงบนหลังให้เลียนแบบเส้นแสงส้มแดงใต้ผิวหนังของเจ้าตัวสี่ขาวัยอ่อนแบบย่อส่วน แม้ตัวมันเองไม่มีพิษหรืออันตรายใดๆ เลย แต่ลายเลียนแบบนี้หลอกให้นักล่าหลายชนิดลังเลพอจะให้มันร่อนหนีทัน เป็นตัวอย่างของ Batesian mimicry ที่ชัดเจนที่สุดในป่าหมอก",
        mutation: { pro: "ลายเรืองแสงเลียนแบบเจ้าตัวสี่ขาวัยอ่อน / นักล่าลังเลก่อนโจมตีเสมอ", con: "ใช้ได้แค่กลางคืนหรือที่มืดพอ / กลางวันลายจางจนไร้ประโยชน์ ต้องพึ่งการพรางตัวแบบธรรมดาแทน" },
        ...
        head: [
            ...
            ["จมูก", "จมูกเล็กไวต่อกลิ่นแมลง", "ตามกลิ่นแมลงและฝูงแสงกะพริบในความมืดได้แม่นยำ"],
            ...
            ["EXTRA #1", "ลายเรืองแสงเลียนแบบบนหลัง (Mimic Glow Pattern)", "เส้นแสงส้มแดงจางๆ เรืองขึ้นเป็นจังหวะตามแนวสันหลัง เลียนแบบเส้นแสงใต้ผิวของเจ้าตัวสี่ขาวัยอ่อนแบบย่อส่วนเป๊ะ ควบคุมความสว่างได้เองตามระดับความตกใจ"],
        ...
        body: [
            ...
            ["TAIL", "หางยาวเรียวไม่เรืองแสง", "Utility — ใช้ถ่วงสมดุลขณะร่อนเท่านั้น ตั้งใจไม่มีลายเรืองแสงเพื่อไม่ให้เผยสัดส่วนตัวจริงที่เล็กกว่าเจ้าตัวสี่ขามาก"]
        ],
        limbs: [
        ...
        pattern: "ลายเรืองแสงเส้นส้มแดงตามแนวสันหลังเลียนแบบเจ้าตัวสี่ขาวัยอ่อนแบบย่อส่วน ล้อมด้วยขนสีน้ำตาลเข้มกลืนความมืดยามค่ำคืน",
        pal: [["สีหลัก", "#78350f"], ["เงา", "#292524"], ["แสง", "#f97373"], ["เสริม A", "#57534e"], ["เสริม B", "#fb923c"]],
        hl: ["#f97373", "ส้มแดงเรืองแสงเลียนแบบเจ้าตัวสี่ขาวัยอ่อน"],
        ...
        mutationFull: {
            ...
            proDesc: "ลายเรืองแสงที่เลียนแบบเส้นแสงใต้ผิวของเจ้าตัวสี่ขาวัยอ่อนได้แม่นยำมากพอจะทำให้นักล่าหลายชนิดลังเลไม่กล้าโจมตีทันที เพราะกลัวจะเจอฝูงเจ้าตัวสี่ขาตัวเต็มวัยซุ่มอยู่ใกล้ๆ เสี้ยววินาทีที่ลังเลนั้นเพียงพอให้มันร่อนหนีได้ทันเสมอ",
        ...
        combat: [
            ["Mimic Glow", "เรืองแสงลายเลียนแบบเจ้าตัวสี่ขาวัยอ่อนทันทีที่รู้สึกถูกจับตามอง สร้างความลังเลให้ผู้ล่าก่อนตัดสินใจโจมตี"],
        ...
        abilities: [
            {
                ...
                desc: "เลียนแบบลายเรืองแสงส้มแดงข้างแก้มของเจ้าตัวสี่ขาวัยอ่อนได้แม่นยำพอจะกระตุ้นสัญชาตญาณระแวงภัยของผู้ที่เคยเผชิญหน้าเจ้าตัวสี่ขามาก่อน ให้ชะงักไปเสี้ยววินาทีก่อนจะทันรู้ตัวว่าเป็นตัวเล็กกว่ามากที่ไม่มีอันตรายจริง แล้วใช้จังหวะนั้นกางพังผืดร่อนหนีไปอีกกิ่งอย่างเงียบเชียบ",
