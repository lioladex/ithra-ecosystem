...
const CORE_MEMORIES = [
    ...
    },
    {
        ...
        prompt: "Photorealistic 3D render, cinematic film-VFX quality, dramatic extreme low-angle worm's-eye shot in 16:9 widescreen cinematic composition, camera positioned just above the molten lava surface itself looking almost straight up, as if floating right at the glowing rock. The bright glowing orange-red lava fills the very bottom edge of the frame, heat shimmer distorting the air directly in front of the lens, while the rest of the composition looks up the full height of a deep volcanic chasm toward the distant opening of the crater rim far above; that distant opening shows NO clear blue sky, no clouds and no green vegetation at all — instead it is a dim, hazy, sickly pale grey-orange smear of drifting ash and volcanic smoke blotting out the sky beyond, barely brighter than the chasm walls themselves, the whole world above choked in the same ashfall haze as the rest of this chapter, the dark rocky chasm walls converging inward toward that murky opening on both sides. A creature built like NEITHER a standard dragon NOR a pterosaur NOR a bird glides low overhead, directly between the camera and the hazy opening: imagine a bat's wings, and a kangaroo's small tucked forearms held at chest height, and an ostrich's legs trailing behind, all present on the SAME body at the SAME time as three completely separate limb pairs, six limbs total, not four — its huge leathery bat-like wings, shark-like micro-scaled and slate-blue-grey above with pale fog-blue below, beat hard and unevenly rather than soaring smoothly, one wing dipped lower than the other as it fights for lift; its second and visibly smaller pair of short muscled arms, positioned on the torso below and separate from the wings, is thrown out stiffly to the side for balance rather than held neatly tucked; its long raptor legs and tail trail limp and off-balance behind it rather than streamlined. Its whole body reads as caught in a desperate, barely-controlled recovery rather than confident flight: neck craned back at an awkward angle, body twisted, feathers and scales on its flank visibly ruffled and disturbed, its four eyes wide and wild, having only just snapped open moments after waking mid-freefall — this is a creature that has never flown before, fighting not to hit the lava, not a majestic soaring predator. Its toothless hooked beak, serrated blade-like edges and translucent solar-sail crest webbed with branching fracture-line veins are visible despite the ash haze. Volumetric orange-red light from the lava blazing upward to light the underside of its wings, belly and crest against the dark chasm walls, subsurface scattering on the thin translucent wing membrane, heat haze, drifting ash and embers rising past camera toward the murky opening above, shallow depth of field with the chasm walls fading into ash-hazed gloom with height and distance, full scene visible, no text, no illustration, no painting, no concept art style."
    },
    {
        chapter: 6,
