...
const CORE_MEMORIES = [
    ...
    },
    {
        ...
        prompt: "Photorealistic 3D render, cinematic film-VFX quality, dramatic extreme low-angle worm's-eye shot in 16:9 widescreen cinematic composition, camera positioned just above the molten lava surface itself looking almost straight up, as if floating right at the glowing rock. The bright glowing orange-red lava fills the very bottom edge of the frame, heat shimmer distorting the air directly in front of the lens, while the rest of the composition looks up the full height of a deep volcanic chasm toward the distant, brighter opening of the crater rim far above, a small patch of pale daylight visible at the very top of the frame where the chasm mouth opens to the sky, the dark rocky chasm walls converging inward toward that distant opening on both sides. A massive wyvern-like flyer with an immense wingspan, four glowing sun-gold eyes, a toothless hooked beak with serrated blade-like edges, and a translucent solar-sail crest webbed with branching fracture-line veins flaring from the back of its skull, its shark-like micro-scaled wings catching a gem-like iridescent sheen, slate-blue-grey above and pale fog-blue below, its four eyes only just snapped open as if waking mid-fall — glides directly overhead, low and close, just a few body-lengths above the lava and directly between the camera and the distant crater opening, its wingtips almost brushing the molten rock, its whole silhouette and glowing wing-undersides seen dramatically from below and behind as it catches a rising thermal updraft and angles upward toward the distant light of the chasm mouth. Volumetric orange-red light from the lava blazing upward to light the underside of its wings, belly and crest brightly against the dark chasm walls, subsurface scattering on the thin translucent wing membrane, heat haze and drifting embers rising past camera toward the distant opening, shallow depth of field with the chasm walls and crater rim softly hazy with height and distance, full scene visible, no text, no illustration, no painting, no concept art style."
    },
    {
        chapter: 6,
