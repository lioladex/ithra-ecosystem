...
const CORE_MEMORIES = [
    ...
    },
    {
        ...
        prompt: "Photorealistic 3D render, cinematic film-VFX quality, chaotic ground-level shot in 16:9 widescreen cinematic composition. A dense grey curtain of drifted volcanic ash chokes the misty forest floor, visibility reduced to only a few body-lengths in every direction — this ash traveled a long distance from a volcano far away and is now just a thick suffocating haze hanging over the mistwood; there is NO volcano, no lava, no eruption, no fire and no glowing embers anywhere in the scene, only flat diffuse grey daylight struggling through the particulate haze with no warm light source of any kind. A dense stampede runs shoulder to shoulder in the same direction through the ash, made ONLY of species from this specific alien ecosystem's own established fauna, not generic dinosaurs, dragons or invented monsters: small hare-sized reddish-umber-brown creatures with short squat round bodies, flashing a bright golden-yellow rump patch as they bolt in scattering clusters underfoot; tall horse-sized long-necked grazers with small beaked heads and translucent leaf-shaped ears folded back, their fan-like solar ruffs collapsed and folded completely flat against their necks rather than unfurled, running alongside them; lean dog-sized four-legged pack predators with thick necks and dimly visible cheek stripes caught up in the same panicked flight as the herbivores around them, no longer hunting. In the middle of the crush, a massive wyvern-like flyer with an immense wingspan runs awkwardly on its long powerful zygodactyl raptor legs, unused to bearing its full weight on the ground — its four eyes, toothless hooked beak with serrated blade-like edges, and translucent solar-sail crest webbed with branching fracture-line veins are all dimly visible through the grey ash, its shark-like micro-scaled wings clamped tight against its body and half-spread only for balance rather than flight, its slate-blue-grey and pale fog-blue countershading caked and dulled further by settling ash, and its short but densely muscled grasping arms with three talons each, normally used to pin down carrion, now held tucked defensively against its chest rather than missing or absent. Its chest heaves for air that will not come, its silhouette rippling faintly at the edges as something shifts and moves beneath its own skin without being told to, though its overall wyvern shape with all three limb pairs — wings, grasping arms, and legs — stays clearly recognizable throughout. Just ahead, the shape of another creature lies motionless on the ground, already being stepped over by the unbroken stampede. Soft, flat, shadowless ash-diffused daylight with no directional glow of any color, subsurface scattering on the rippling silhouette's edges, motion-blurred legs of the stampede pressing in from both sides, shallow depth of field, full scene visible, no text, no illustration, no painting, no concept art style."
    },
    {
        chapter: 5,
