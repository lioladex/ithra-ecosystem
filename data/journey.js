/* =================================================================
   ...
   เดียวกับบทที่กำลังเขียนอยู่:
     ...
     journey/chapter6.js    บทที่ 6 "สองจ้าวป่า"
...
const JOURNEY_CHAPTERS = [
    ...
    },
    {
        ...
        title: "สองจ้าวป่า",
        range: "T+12",
        startId: "flight-from-ash",
        endId: "__end_ch6__",
        closeTag: "// จบบทที่ 6 — เห็นจ้าวป่าสองตัวประจัญบานกัน และเริ่มสงสัยว่าเสียงที่สั่งให้ยืนหยัดในวันแรกอาจไม่ใช่เสียงของเหยื่อ",
        closeText: "หนีภูเขาไฟมาไกลจนหลงเข้าเขตล่าของจ้าวป่าตัวใหม่โดยไม่ทันรู้ตัว ได้เห็นตัวสีดำสนิทที่เคยทำให้หัวใจหยุดเต้นในวันแรกต้องสู้เพื่อเอาชีวิตรอดจากสิ่งขาวซีดที่ไม่เคยรู้จักมาก่อน และเอาชนะมันได้ด้วยความเร็วกับพลังที่เหนือกว่า ภาพการต่อสู้นั้นปลุกความทรงจำเก่าที่ไม่เคยเข้าใจขึ้นมาอีกครั้ง คำถามที่ค้างมาตั้งแต่วันแรกกำลังจะพลิกกลับด้านทั้งหมด บทถัดไปยังอยู่ระหว่างการพัฒนา",
        nextLabel: "Continue Journey",
        reflections: [
            { kind: "gain", text: "ฉันได้รู้จักความรู้สึกอันตรายที่ผุดขึ้นเองก่อนจะเห็นอะไรด้วยซ้ำ" },
            { kind: "gain", text: "ฉันได้เห็นร่างปีกกว้างของฉันบินไม่ได้อย่างอิสระอีกต่อไปเป็นครั้งแรก" },
            { kind: "gain", text: "ฉันได้เห็นจ้าวป่าตัวใหม่ที่ไม่เคยรู้จักมาก่อนเลย" },
            { kind: "loss", text: "ฉันเสียความเชื่อว่าความเงียบสมบูรณ์ของตัวสีดำสนิทนั้นไม่มีทางถูกจับได้เลย" },
            { kind: "gain", text: "ฉันได้เห็นสองจ้าวป่าต่อสู้กันจนจบโดยไม่มีใครรู้ว่าฉันอยู่ตรงนั้น" },
            { kind: "loss", text: "ฉันเสียความเป็นไปได้สุดท้ายว่าเสียงที่เคยสั่งให้ฉันยืนหยัดไว้ในวันแรกจะเป็นเสียงของเหยื่อที่จนตรอก" }
        ]
    }
];
