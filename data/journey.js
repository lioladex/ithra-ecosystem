...
const JOURNEY_STEPS = [
    ...
    },
    {
        ...
        paragraphs: [
            ...
            `มันไม่เคยมีชื่อมาก่อนในชีวิตที่ผ่านมาทั้งหมด จนวินาทีนี้ที่มันมีชื่อแล้ว: <em class="glow-danger">เจ็บ</em>`,
    ...
    },
    {
        ...
        paragraphs: function () {
            ...
            return [
                openLine,
                `เหลือความเงียบอีกครั้ง ร่างที่เพิ่งรอดมาได้ทรุดคออยู่กับพื้น สายตายังคงจ้องไปยังจุดที่มันเพิ่งหายลับไป ระยะใกล้ขนาดนี้เห็นชัดเป็นครั้งแรก: ดวงตาสี่ดวงสีทองสว่าง จะงอยปากรูปตะขอ ผิวปีกเหลือบรุ้งจางๆ เมื่อกระทบแสงเหมือนหินแร่เจียระไน และแผงเยื่อบางๆ ท้ายทอยที่กางแผ่ออกตอนกระพือ`,
