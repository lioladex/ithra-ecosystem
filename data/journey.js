...
const JOURNEY_STEPS = [
    ...
    },
    {
        ...
        paragraphs: [
            ...
            `ระหว่างที่สายตาเพิ่งปรับตัวเข้ากับแสงสลัวของป่าหมอก มีเงาบางอย่างขนาดใหญ่เคลื่อนผ่านช่องว่างเรือนยอดเบื้องบนไปอย่างรวดเร็ว เงียบเชียบจนแทบไม่ทันสังเกต ก่อนจะหายลับเข้าไปในหมอกอีกครั้ง`
        ],
        actions: [
            {
                id: "observe-shadow-1",
    ...
    },
    {
        ...
        actions: [
            ...
            },
            {
                ...
                unlockKey: "SKYTHER",
                teachesSkill: "FLIGHT",
                text: `จ้องตามทุกจังหวะ คราวนี้เห็นชัดว่ามันไม่ได้ขยับปีกทั้งสองข้างพร้อมกันเวลาจะเปลี่ยนทิศ แต่เอียงปลายปีกข้างหนึ่งลงต่ำกว่าอีกข้างเพียงเล็กน้อย แค่นั้นทั้งลำตัวก็เอียงตามและพลิกทิศทันทีโดยไม่ต้องออกแรงกระพือเลยสักครั้ง — ครั้งแรกที่เห็นเงานั้นแค่ลอยนิ่งเฉยๆ แต่ครั้งนี้เห็นว่ามันบังคับทิศทางได้ด้วยการเอียงปีกเพียงเท่านั้น`
            }
        ],
    ...
    },
    {
        ...
        paragraphs: [
            ...
            `Karvos ตัวแรกทะยานเข้าใส่ ลอยตัวกลางอากาศเต็มที่ในจังหวะกระโจน — ช่วงเวลาที่มันช่วยตัวเองไม่ได้เลยสักเสี้ยววินาที`,
            `ขาหน้ายกขึ้นสวนกลางอากาศ กระแทกเข้ากับลำตัวที่กำลังลอยเต็มแรง น้ำหนัก 310 กิโลกรัมปะทะเข้ากับ 58 กิโลกรัมที่ไร้จุดยืนกลางอากาศ — Karvos กระเด็นทะลุพุ่มไม้ไปไกลหลายเมตร ร่างล้มนิ่งไม่ขยับอีกเลย`
        ],
    ...
    },
    {
        ...
        paragraphs: [
            ...
            `ทีละตัว...ทีละตัว จังหวะการล้อมเริ่มแตก จนฝูงที่เหลือถอยห่างออกไปพร้อมกัน ก่อนจะหันหลังวิ่งหายเข้าไปในหมอกจนหมด`
        ],
    ...
    },
    {
        ...
        paragraphs: [
            ...
            `ขาสี่ข้างเริ่มสั่นโดยสั่งไม่ได้ ภาพตรงหน้าค่อยๆ แคบลงเป็นวงมืดจนเหลือแค่จุดเดียว แล้วพื้นก็โถมเข้าหาอย่างไม่ทันตั้งตัว`,
        ...
        actions: [
            {
                ...
                apCost: 1,
                text: `ขาที่ถูกกัดสะบัดสวนกลับเต็มแรงโดยไม่ทันคิด แรงกระแทกจากขาหนักอึ้งฟาดเข้ากับปีกและซี่โครงที่บางเบา — เสียงกระดูกร้าวดังก้องแทรกเสียงหมอก Skyther กรีดร้องหลุดจากขาทันที ปีกข้างหนึ่งพับผิดรูปตั้งแต่ตอนที่ยังลอยตัวขึ้นไม่พ้นพื้น`
            }
        ],
    ...
    },
    {
        ...
        paragraphs: function () {
            ...
            const openLine = kicked
                ? `เสียงกรีดร้องของ Skyther ยังก้องอยู่ในอากาศ ปีกข้างหนึ่งที่หักพับกระพือไม่เป็นจังหวะ มันไถลตัวหนีเข้าพุ่มไม้อย่างทุลักทุเล ทิ้งรอยเลือดเป็นจุดๆ ไว้ตามทาง`
            ...
            return [
                openLine,
                `เหลือความเงียบอีกครั้ง ร่างที่เพิ่งรอดมาได้ทรุดคออยู่กับพื้น สายตายังคงจ้องไปยังจุดที่มันเพิ่งหายลับไป — เงาปีกกว้าง ท่วงท่าตอนบิน ทุกอย่างที่เพิ่งเห็นมาทั้งหมดในระยะประชิดขนาดนี้`,
    ...
    },
    {
        ...
        paragraphs: function () {
            ...
            if (kicked) {
                base.push(`ระหว่างลองผิดลองถูกอยู่นั้นเอง กลิ่นและเสียงกระพือปีกที่ไม่เป็นจังหวะดังแทรกมาจากพุ่มไม้ใกล้ๆ — Skyther ตัวเดิมที่ปีกหักยังคงอยู่แถวนั้น พยายามกระพือปีกข้างที่ยังใช้ได้ซ้ำแล้วซ้ำเล่าเพื่อพยุงตัวขึ้นจากพื้น แต่ทุกครั้งก็ทำได้แค่กระเผลกไปไม่กี่ก้าว`);
            } else {
        ...
        actions: [
            ...
            },
            {
                ...
                prompt: "👁 สังเกต Skyther ตัวที่บาดเจ็บ",
                apCost: 1,
                teachesSkill: "FLIGHT",
    ...
    },
    {
        ...
        key: true,
        paragraphs: [
            `กิ่งไม้ตรงหน้าขยับเบาๆ ก่อนจะเผยร่างเล็กที่มีดวงตากลมโตคู่หนึ่ง — Vashli ตัวหนึ่งกำลังหลับตาพักอยู่บนกิ่ง ไม่รู้ตัวเลยว่ากำลังถูกจ้องมองอยู่`,
        ...
        actions: [
            ...
            },
            {
                ...
                apCost: 1,
                teachesSkill: "FLIGHT",
                text: `พุ่งเข้าใส่ก่อนจะพร้อมจริง — พลาดเป้าไปเฉียดๆ Vashli สะดุ้งตื่นแต่ยังไม่ทันหนีไปไกล ยังคงงงงวยอยู่บนกิ่งเดิม ให้โอกาสอีกครั้ง`
            }
        ],
    ...
    },
    {
        ...
        paragraphs: function () {
            ...
            const strikeLine = mastered
                ? `แรงขับที่ไม่เคยรู้จักมาก่อนผลักดันเต็มที่ ปีกเอียงจับกระแสลมได้พอดีเป๊ะ ร่างพุ่งดิ่งตรงเป้าหมายเป็นเส้นตรงไม่มีสะดุดแม้แต่จังหวะเดียว กรงเล็บลงล็อกอย่างแม่นยำก่อน Vashli จะทันขยับตัวด้วยซ้ำ`
            ...
            return [
                strikeLine,
                `จบลงเร็วมาก — เร็วกว่าที่คาดคิดไว้มาก Vashli ไม่มีโอกาสแม้แต่จะร้องหนี`,
                ...
                `นี่แหละคือสิ่งที่ Karvos รู้สึกทุกครั้งที่ไล่ล่า Luvenn — ไม่ใช่ความโหดร้าย ไม่ใช่ความชั่วร้าย แต่เป็นเพียงความจำเป็นเดียวกันกับที่เพิ่งรู้จักไปเมื่อครู่นี้เอง`,
        ...
        actions: [
            {
                ...
                apCost: 1,
                teachesSkill: "FLIGHT",
                text: `ก่อนจะทันคิด ปีกทั้งสองข้างกระพือสะบัดแรงดันตัวเองทะยานขึ้นไปเกาะกิ่งไม้ที่สูงกว่าเดิม พาซากที่เพิ่งจับได้ติดกรงเล็บขึ้นไปด้วย — สัญชาตญาณบางอย่างเตือนว่าพื้นด้านล่างไม่ใช่ที่ปลอดภัยสำหรับร่างแบบนี้ ยิ่งอยู่สูงเท่าไหร่ ยิ่งปลอดภัยจากสิ่งที่อาจแอบซุ่มอยู่เบื้องล่าง`
            }
        ],
    ...
    },
    {
        ...
        paragraphs: [
            ...
            `ความหิว กลิ่น การฆ่าเพื่อกิน — ทั้งหมดที่เพิ่งเรียนรู้มาทีละอย่างตอนนี้ประกอบรวมกันเป็นภาพเดียว: ภาพของฝูง Karvos ที่มันเคยเผชิญหน้า`,
        ...
        // paragraph แรกบรรยายว่า "กางปีกเต็มที่...ทะยานขึ้น...อย่างมั่นใจ" และ
        // ย่อหน้าสุดท้าย "ปีกกว้างเอียงจับกระแสลม" อยู่แล้ว — เนื้อเรื่องเองบอกว่า
        // เข้าใจสรีระการบินของตัวเองแล้วจริงๆ จึงให้ observation ฟรี 1 ครั้งโดย
        // ไม่ต้องมี action ให้กด (ต่างจาก step อื่นๆ ที่ต้องกดเรียนรู้เอง)
        teachesSkillOnEntry: "FLIGHT",
...
function journeyContinue() {
    ...
    // observation ฟรีที่ผูกกับตัวเนื้อเรื่องเอง ไม่ใช่ action ที่ต้องกด — ใช้ตอนที่
    // paragraph ของ step นั้นบรรยายถึงความเข้าใจ/พฤติกรรมของ skill นั้นอยู่แล้ว
    // (เช่น step "understanding-karvos" ที่บรรยายว่าบินคล่องแล้วในเนื้อเรื่อง)
    if (isNewGround && step.teachesSkillOnEntry && typeof skillObserve === 'function') {
        skillObserve(step.teachesSkillOnEntry);
    }
