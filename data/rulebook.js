...
const RULEBOOK_HTML = `
            ...
            <table class="data-table">
                ...
                <tr><td>Vorthak</td><td>I</td><td>ไม่ผูก silhouette กับ Luvenn เลย — ความเชื่อมโยงอยู่ที่ "เทคนิคการล่าแบบ Counter" ที่หลั่งไหลออกมาทางสัญชาตญาณตอนตัวเอกอยู่ในร่าง Luvenn เท่านั้น ไม่ใช่รูปร่าง</td></tr>
                <tr><td>Thessek</td><td>I</td><td>ร่วมกับ Karvos แค่ "รูปร่างท่าทางเดิน 4 ขา เป็นนักล่า ขนาดตัวใกล้เคียงกัน" (common silhouette ที่ก่อความสับสนในฉากตื่นรู้ได้) — ส่วนอื่นออกแบบอิสระ</td></tr>
                ...
                <tr><td>Frostmane</td><td>I</td><td>ต้องคง "ภาพสัตว์กีบขนหนา" ไว้เพื่อให้ contrast กับ Vorthak เห็นผล — ส่วนอื่นออกแบบอิสระ</td></tr>
                <tr><td>Dunkrell</td><td>I</td><td>ไม่มี</td></tr>
                <tr><td>Pallowfin</td><td>I</td><td>ไม่มี</td></tr>
                <tr><td>Mistcrawler</td><td>I</td><td>ไม่มี</td></tr>
                <tr><td>Threndle</td><td>II</td><td>ไม่มี</td></tr>
                <tr><td>Glimmerwing</td><td>II</td><td>ไม่มี</td></tr>
                <tr><td>Korrune</td><td>III</td><td>ไม่มี</td></tr>
                <tr><td>Cindergrub</td><td>III</td><td>ไม่มี</td></tr>
            </table>
            <div class="note-block">Tier IV และ V ยังไม่มีตัวใดใช้จริง — เผื่อไว้สำหรับสิ่งมีชีวิตที่ต้องการความเอเลี่ยนสุดขั้วกว่าตัวที่มีอยู่ทั้งหมด</div>
