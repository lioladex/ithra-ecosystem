...
**ดีไซน์ที่ตกลงไว้แต่ยังไม่ implement**: ระดับความรู้แบบที่ 3 คือ "รู้จักผ่านคำเล่าลือ/ชื่อเล่นชั่วคราว" (ต่ำกว่า tier 0 ปัจจุบัน) — เช่น Confluence เจอ Easter Egg ที่ไม่ผูกข้อมูลใดๆ เลย (ก้อนน้ำแข็งประหลาด) ไม่ควรนับเป็น unlock ใดๆ ทั้งสิ้น แต่ถ้าในอนาคตมีฉากที่ Confluence ได้ยินคนอื่นเล่าถึงสิ่งมีชีวิตแบบคร่าวๆ ควรปลดล็อกแค่ "ชื่อเล่นชั่วคราว" (field `nickname` ใหม่ที่ยังไม่มีในไฟล์ creature) แทนชื่อจริง จนกว่าจะได้ Direct Visual จริง — ต้องคิด schema เพิ่ม (`unlockRumor`, `nickname` field, UI 3 สถานะแทน 2) ก่อนเริ่มทำ
